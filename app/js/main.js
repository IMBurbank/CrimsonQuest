...
var AccentLayer = function (_React$Component10) {
  _inherits(AccentLayer, _React$Component10);

  function AccentLayer(props) {
    _classCallCheck(this, AccentLayer);

    var _this10 = _possibleConstructorReturn(this, (AccentLayer.__proto__ || Object.getPrototypeOf(AccentLayer)).call(this, props));

    _this10.initAccArr = _this10.initAccArr.bind(_this10);
    _this10.initTempCanvas = _this10.initTempCanvas.bind(_this10);
    _this10.getAccImages = _this10.getAccImages.bind(_this10);
    _this10.initPaletteMaps = _this10.initPaletteMaps.bind(_this10);
    _this10.setPalettes = _this10.setPalettes.bind(_this10);
    _this10.setPaletteArrMap = _this10.setPaletteArrMap.bind(_this10);
    _this10.setAccArr = _this10.setAccArr.bind(_this10);
    _this10.drawAccents = _this10.drawAccents.bind(_this10);
  ...
  _createClass(AccentLayer, [{
    ...
    key: 'drawAccents',
    value: function drawAccents(nextProps, nextState) {
      var accArr = nextProps.accArr,
    ...
    value: function componentWillUpdate(nextProps, nextState) {
      ...
      } else if (this.props.playerArr !== nextProps.playerArr && nextProps.playerArr !== [0, 0] && nextState.dec0Canv) {
        this.drawAccents(nextProps, nextState);
      }
    }
  }, {
...
var GameStage = function (_React$Component11) {
  _inherits(GameStage, _React$Component11);

  function GameStage(props) {
    _classCallCheck(this, GameStage);

    var _this11 = _possibleConstructorReturn(this, (GameStage.__proto__ || Object.getPrototypeOf(GameStage)).call(this, props));

    _this11.updateBgArr = _this11.updateBgArr.bind(_this11);
    _this11.handleKeyDown = _this11.handleKeyDown.bind(_this11);
    _this11.updateAccArr = _this11.updateAccArr.bind(_this11);
...
var Game = function (_React$Component12) {
  _inherits(Game, _React$Component12);
  ...
  function Game(props) {
    ...
    _this12.updatePlayerArr = _this12.updatePlayerArr.bind(_this12);
...
var PageHeader = function (_React$Component13) {
  _inherits(PageHeader, _React$Component13);
...
var PageFooter = function (_React$Component14) {
  _inherits(PageFooter, _React$Component14);
